	...
	$.fn.Menu = function(options)
	{
		...
		this.oneMenus.each(function(i)
		{
			...
			$(this).children("span").first().bind("click",function() 
			{
				...
				//var g_oMenu=i+"_0"
				//alert(g_oMenu)
				//$("#menu").Menu({defaultCur : g_oMenu});
				//showmenuconfig('OsdSet', 0, 'FastSetConfig')
				//showmenuconfig(showmenuconfig('OsdSet', 0, 'FastSetConfig'));
				//alert($(this).next().text())
				//alert($(this).next().attr("href"))
				
				//var stra=$(this).next().html()
				//var str1 = str.split(":");
				//alert(stra)
				//$(this).next().click();
				     //$(this).next("a").click();
				//var str=$(this).next().attr("href")
				//var str1 = str.split(":");
				//alert(str+"  "+str1[1])
			//	javascript:showmenuconfig('System', 0, 'SystemConfig')  showmenuconfig('System', 0, 'SystemConfig')  
				//showmenuconfig(showmenuconfig('OsdSet', 0, 'FastSetConfig'));
				//showmenuconfig('StorageManagement', 0, 'StorageConfig')
				//var tt=str1[1];
			//	tt;
			//	document.getElementById('aIPAddress').click();
				//$(this).click(tt);
				//alert(tt)
				//alert(
				//str1[1]+"\n"+
				//showmenuconfig(str1[1]));
				//str;
				//str1[1];
