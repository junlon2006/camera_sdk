...
ifeq ($(LINUX_COMPILER),_ARM_DM365_)   
   CFLAGS += -DARCH=ARM -D_ARM_DM365_
   CFLAGS += -D_ARM_
endif


ifeq ($(LINUX_COMPILER),_ARM_A5S_)   
   CFLAGS += -DARCH=ARM -D_ARM_DM365_
   CFLAGS += -D_ARM_
endif

ifeq ($(LINUX_COMPILER),_ARM_S2_)   
   CFLAGS += -DARCH=ARM
   CFLAGS += -D_ARM_
endif

ifeq ($(LINUX_COMPILER),_HIS3518_)   
   CFLAGS += -DARCH=ARM
   CFLAGS += -D_ARM_
   CFLAGS += -D_HIS3518_
endif
ifeq ($(LINUX_COMPILER),_BAYTRAIL_)    
   CFLAGS += -D_BAYTRAIL_
endif

ifeq ($(LINUX_COMPILER),_NETRA_)   
   CFLAGS += -DARCH=ARM 
   CFLAGS += -D_ARM_
endif
...
ifeq ($(LINUX_COMPILER),_ARM_DM365_)
CROSS = /opt/mv_pro_5.0/montavista/pro/devkit/arm/v5t_le/bin/arm_v5t_le-
endif



ifeq ($(LINUX_COMPILER),_ARM_A5S_)
CROSS = /opt/toolchain/arm-2011.09/bin/arm-none-linux-gnueabi-
endif

ifeq ($(LINUX_COMPILER),_ARM_S2_)
CROSS = /opt/ambarella/s2/toolchain/linaro-multilib-2013.09-gcc4.8/bin/arm-linux-gnueabihf-
endif
ifeq ($(LINUX_COMPILER),_HIS3518_)
CROSS = /opt/hisi-linux-nptl/arm-hisiv100-linux/target/bin/arm-hisiv100nptl-linux-
endif
ifeq ($(LINUX_COMPILER),_BAYTRAIL_)
CROSS = 
endif
